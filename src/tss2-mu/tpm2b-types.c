...
/* V185: PQC TPM2B types */
TPM2B_MARSHAL(TPM2B_MLKEM_PUBLIC_KEY);
TPM2B_UNMARSHAL(TPM2B_MLKEM_PUBLIC_KEY, buffer);
TPM2B_MARSHAL(TPM2B_MLKEM_PRIVATE_KEY);
TPM2B_UNMARSHAL(TPM2B_MLKEM_PRIVATE_KEY, buffer);
TPM2B_MARSHAL(TPM2B_MLKEM_CIPHERTEXT);
TPM2B_UNMARSHAL(TPM2B_MLKEM_CIPHERTEXT, buffer);
TPM2B_MARSHAL(TPM2B_MLDSA_PUBLIC_KEY);
TPM2B_UNMARSHAL(TPM2B_MLDSA_PUBLIC_KEY, buffer);
TPM2B_MARSHAL(TPM2B_MLDSA_PRIVATE_KEY);
TPM2B_UNMARSHAL(TPM2B_MLDSA_PRIVATE_KEY, buffer);
TPM2B_MARSHAL(TPM2B_MLDSA_SIGNATURE);
TPM2B_UNMARSHAL(TPM2B_MLDSA_SIGNATURE, buffer);
