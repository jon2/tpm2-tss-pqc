...
/* V185: PQC list types */
TPML_MARSHAL(TPML_ML_PARAMETER_SET, Tss2_MU_TPMS_ML_PARAMETER_SET_Marshal, parameterSets, ADDR)
TPML_UNMARSHAL(TPML_ML_PARAMETER_SET, Tss2_MU_TPMS_ML_PARAMETER_SET_Unmarshal, parameterSets)
