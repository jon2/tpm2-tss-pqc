...
TPMU_MARSHAL2(TPMU_SENSITIVE_COMPOSITE,
              ...
              ADDR,
              mlkem,
              Tss2_MU_TPM2B_MLKEM_PRIVATE_KEY_Marshal,
              TPM2_ALG_MLDSA,
              ADDR,
              mldsa,
              Tss2_MU_TPM2B_MLDSA_PRIVATE_KEY_Marshal)
TPMU_UNMARSHAL2(TPMU_SENSITIVE_COMPOSITE,
                ...
                TPM2_ALG_MLKEM,
                mlkem,
                Tss2_MU_TPM2B_MLKEM_PRIVATE_KEY_Unmarshal,
                TPM2_ALG_MLDSA,
                mldsa,
                Tss2_MU_TPM2B_MLDSA_PRIVATE_KEY_Unmarshal)
...
TPMU_MARSHAL2(TPMU_PUBLIC_ID,
              ...
              ADDR,
              mlkem,
              Tss2_MU_TPM2B_MLKEM_PUBLIC_KEY_Marshal,
              TPM2_ALG_MLDSA,
              ADDR,
              mldsa,
              Tss2_MU_TPM2B_MLDSA_PUBLIC_KEY_Marshal)
TPMU_UNMARSHAL2(TPMU_PUBLIC_ID,
                ...
                TPM2_ALG_MLKEM,
                mlkem,
                Tss2_MU_TPM2B_MLKEM_PUBLIC_KEY_Unmarshal,
                TPM2_ALG_MLDSA,
                mldsa,
                Tss2_MU_TPM2B_MLDSA_PUBLIC_KEY_Unmarshal)
