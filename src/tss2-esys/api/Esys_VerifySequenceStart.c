 ...
 * @param[in]  keyHandle Handle of a loaded key for verification.
...
Esys_VerifySequenceStart(ESYS_CONTEXT          *esysContext,
    ...
    r = Esys_VerifySequenceStart_Async(esysContext, keyHandle, shandle1, shandle2,
                                        shandle3, signature);
 ...
 *
 * This function invokes the TPM2_VerifySequenceStart command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_VerifySequenceStart_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of a loaded key for verification.
 * @param[in]  shandle1 First session handle.
...
Esys_VerifySequenceStart_Async(ESYS_CONTEXT         *esysContext,
                               ...
                               const TPMT_SIGNATURE *signature) {
    TSS2_RC r;
    LOG_TRACE("context=%p, keyHandle=%" PRIx32 ", signature=%p",
              esysContext, keyHandle, signature);
 ...
 * invoked via Esys_VerifySequenceStart_Finish. All non-simple output parameters
