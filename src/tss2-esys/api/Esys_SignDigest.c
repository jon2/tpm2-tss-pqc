 ...
 * @param[in]  inScheme Signing scheme to use if the scheme for keyHandle is
 *             TPM2_ALG_NULL.
...
Esys_SignDigest(ESYS_CONTEXT              *esysContext,
    ...
    r = Esys_SignDigest_Async(esysContext, keyHandle, shandle1, shandle2,
                              shandle3, digest, inScheme, validation);
 ...
 *
 * This function invokes the TPM2_SignDigest command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_SignDigest_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of key that will perform signing.
 * @param[in]  shandle1 First session handle.
 ...
 * invoked via Esys_SignDigest_Finish. All non-simple output parameters
