 ...
 * @param[out] validation Ticket of validation.
 *             (callee-allocated)
...
Esys_VerifyDigestSignature(ESYS_CONTEXT          *esysContext,
    ...
    r = Esys_VerifyDigestSignature_Async(esysContext, keyHandle, shandle1,
                                         shandle2, shandle3, digest, signature);
 ...
 *
 * This function invokes the TPM2_VerifyDigestSignature command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_VerifyDigestSignature_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of public key that will be used in the
 *             validation.
 ...
 * invoked via Esys_VerifyDigestSignature_Finish. All non-simple output parameters
