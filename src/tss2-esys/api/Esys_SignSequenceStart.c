 ...
 * @param[in]  keyHandle Handle of a loaded signing key.
 * @param[in]  shandle1 First session handle.
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  inScheme The signing scheme to use.
 * @param[in]  keyB Handle of a second key.
 * @param[out] sequenceHandle  ESYS_TR handle of ESYS resource for the sequence.
...
Esys_SignSequenceStart(ESYS_CONTEXT          *esysContext,
    ...
    r = Esys_SignSequenceStart_Async(esysContext, keyHandle, shandle1, shandle2,
                                     shandle3, inScheme, keyB);
 ...
 *
 * This function invokes the TPM2_SignSequenceStart command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_SignSequenceStart_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of a loaded signing key.
 * @param[in]  shandle1 First session handle.
...
Esys_SignSequenceStart_Async(ESYS_CONTEXT          *esysContext,
                             ...
                             ESYS_TR                keyB) {
    TSS2_RC r;
    LOG_TRACE("context=%p, keyHandle=%" PRIx32 ", inScheme=%p, keyB=%" PRIx32 "",
              esysContext, keyHandle, inScheme, keyB);
    TSS2L_SYS_AUTH_COMMAND auths;
    RSRC_NODE_T           *keyHandleNode;
    RSRC_NODE_T           *keyBNode;
    ...
    r = esys_GetResourceObject(esysContext, keyB, &keyBNode);
    return_state_if_error(r, ESYS_STATE_INIT, "keyB unknown.");
    ...
    r = Tss2_Sys_SignSequenceStart_Prepare(
        ...
        inScheme,
        (keyBNode == NULL) ? TPM2_RH_NULL : keyBNode->rsrc.handle);
    ...
    r = iesys_gen_auths(esysContext, keyHandleNode, keyBNode, NULL, &auths);
 ...
 * invoked via Esys_SignSequenceStart_Finish. All non-simple output parameters
