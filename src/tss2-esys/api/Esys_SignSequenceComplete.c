...
Esys_SignSequenceComplete(ESYS_CONTEXT           *esysContext,
    ...
    r = Esys_SignSequenceComplete_Async(esysContext, sequenceHandle, shandle1,
 ...
 *
 * This function invokes the TPM2_SignSequenceComplete command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_SignSequenceComplete_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  sequenceHandle Handle of the sequence object.
 * @param[in]  shandle1 First session handle.
 ...
 * invoked via Esys_SignSequenceComplete_Finish. All non-simple output parameters
