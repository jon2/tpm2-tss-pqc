 ...
 * @param[in]  sequenceHandle Handle of the sequence object.
 * @param[in]  shandle1 First session handle.
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  buffer Data to be added to the sequence.
 * @param[out] validation The verification ticket.
 *             (callee-allocated)
...
Esys_VerifySequenceComplete(ESYS_CONTEXT           *esysContext,
    ...
    r = Esys_VerifySequenceComplete_Async(esysContext, sequenceHandle, shandle1,
 ...
 *
 * This function invokes the TPM2_VerifySequenceComplete command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_VerifySequenceComplete_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  sequenceHandle Handle of the sequence object.
 * @param[in]  shandle1 First session handle.
 ...
 * invoked via Esys_VerifySequenceComplete_Finish. All non-simple output parameters
