 ...
 * @param[in]  cipherText The cipher text to decapsulate.
...
Esys_Decapsulate(ESYS_CONTEXT                *esysContext,
    ...
    r = Esys_Decapsulate_Async(esysContext, keyHandle, shandle1, shandle2, shandle3,
                               cipherText, label);
     ...
     */
    do {
        r = Esys_Decapsulate_Finish(esysContext, outSymSeed);
 ...
 *
 * This function invokes the TPM2_Decapsulate command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_Decapsulate_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of a loaded key.
 * @param[in]  shandle1 First session handle.
...
Esys_Decapsulate_Async(ESYS_CONTEXT                *esysContext,
                       ...
                       const TPM2B_DATA             *label) {
    TSS2_RC r;
    LOG_TRACE("context=%p, keyHandle=%" PRIx32 ", cipherText=%p, label=%p",
              esysContext, keyHandle, cipherText, label);
 ...
 * invoked via Esys_Decapsulate_Finish. All non-simple output parameters
...
Esys_Decapsulate_Finish(ESYS_CONTEXT *esysContext,
                        TPM2B_DATA  **outSymSeed) {
    TSS2_RC r;
    LOG_TRACE("context=%p, outSymSeed=%p", esysContext, outSymSeed);
